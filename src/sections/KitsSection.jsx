...
export function KitsSection() {
  ...
  // ⭐ Kits con nuevos títulos personalizados
  const kits = [
    {
      kitTitle: "KIT PRO",
      ...
      features: [
        "colchoneta antideslizante tipo gym",
        "Set x3 bandas de tela",
        "Gris: Light",
        "Rosado: Medium",
        "Negra: Heavy",
        "Tula de maya",
        "Tobilleras 5 Kilos (2,5 Kilos cada una) peso removible.",
        "2 hexagonales en HIERRO 5libras cada una.",
      ],
      price: "$199.900",
      popular: true,
    },
    {
      ...
      features: [
        ...
        "Negra: Heavy",
        "Tula de maya",
        "Tobilleras de 5 kilos, (2,5 Kilos cada una) peso removible.",
      ],
      price: "$90.000",
      popular: false,
    },
      ...
      >
        ...
        <div className="container relative z-10 mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold mb-4 text-yellow-400">TRANSFORMA TU CUERPO CON EL KIT IDEAL</h2>
            <p className="text-purple-200 max-w-2xl mx-auto">
              Entre más completo tu kit, más rápido verás resultados.
            </p>
            <p className="text-purple-200 max-w-2xl mx-auto">
              ¡Equípate como una pro y entrena sin límites desde casa!
            </p>
          </div>
            ...
            {kits.map((kit, index) => (
              ...
              >
                ...
                <CardHeader className="text-center pb-4">
                  ...
                  {/* ⭐ TÍTULO NUEVO AMARILLO */}
                  <h3 className="text-2xl font-extrabold text-yellow-400 mb-4 animate-glow">
                    {kit.kitTitle}
                  </h3>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="text-center pt-4">
                    <div className="text-4xl font-extrabold text-yellow-400 mb-4 animate-glow">
                      {kit.price}
                    </div>
                  </div>
                </CardContent>
